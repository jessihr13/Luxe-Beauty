// Admin Payments Integrations Page
// app/admin/integraciones/pagos/page.tsx
...
import { ArrowLeft, CreditCard, CheckCircle2, XCircle, Settings } from 'lucide-react';
            ...
            <div className="max-w-7xl mx-auto">
                    ...
                    <div className="flex items-center gap-4">
                        ...
                        <div>
                            ...
                            <p className="text-gray-600 mt-2">
                                Configura procesadores de pago
                            </p>
                        </div>
                    </div>
                </div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
                    <div className="card-luxury p-6">
                        ...
                        <div className="text-3xl font-bold">{paymentIntegrations.length}</div>
                    </div>
                    <div className="card-luxury p-6">
