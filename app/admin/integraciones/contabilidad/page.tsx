// Admin Accounting Integrations Page
// app/admin/integraciones/contabilidad/page.tsx
...
import { ArrowLeft, FileText, CheckCircle2, XCircle, Settings } from 'lucide-react';
            ...
            <div className="max-w-7xl mx-auto">
                <div className="mb-8 flex items-center justify-between">
                    <div className="flex items-center gap-4">
                        ...
                        <div>
                            <h1 className="text-4xl font-serif font-bold gradient-text">Integraciones de Contabilidad</h1>
                            <p className="text-gray-600 mt-2">Configura sistemas de facturación y contabilidad</p>
                        </div>
                    </div>
                </div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
                    <div className="card-luxury p-6">
                        ...
                        <div className="text-3xl font-bold">{accountingIntegrations.length}</div>
                    </div>
                    <div className="card-luxury p-6">
                        <div className="text-sm text-gray-600 mb-1">Activas</div>
                        <div className="text-3xl font-bold text-green-600">
                            {accountingIntegrations.filter(i => i.isEnabled).length}
                        </div>
                    </div>
                    <div className="card-luxury p-6">
